 ...
 */
export const isDev = new BoolFlag("REX_DEV", false);

/** The port to listen on. Defaults to port 8000. */
export const port = new IntFlag("REX_PORT", 8000);

/** Whether to automatically cache assets. Enabled for non-dev by default. */
export const cacheAssets = new BoolFlag("REX_CACHE_ASSETS", () => !isDev.get());
